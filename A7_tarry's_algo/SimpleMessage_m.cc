...
void SimpleMessage::copy(const SimpleMessage& other)
{
    ...
    this->destiontion = other.destiontion;
...
void SimpleMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->destiontion);
...
void SimpleMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->destiontion);
    doParsimUnpacking(b,this->kind);
    doParsimUnpacking(b,this->count);
}

int SimpleMessage::getSource() const
{
    return this->source;
}

void SimpleMessage::setSource(int source)
{
    this->source = source;
}

int SimpleMessage::getDestiontion() const
{
    return this->destiontion;
}

void SimpleMessage::setDestiontion(int destiontion)
{
    this->destiontion = destiontion;
}

int SimpleMessage::getKind() const
{
    return this->kind;
}

void SimpleMessage::setKind(int kind)
{
    this->kind = kind;
}

int SimpleMessage::getCount() const
{
    return this->count;
}

void SimpleMessage::setCount(int count)
{
    this->count = count;
}
...
int SimpleMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='d' && strcmp(fieldName, "destiontion")==0) return base+1;
...
std::string SimpleMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getDestiontion());
...
bool SimpleMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setDestiontion(string2long(value)); return true;
